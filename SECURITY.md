...
[PyPI](https://pypi.org/project/fastapi-request-observability/). Older releases,
...
[GitHub private vulnerability reporting](https://github.com/janisto/fastapi-observability/security/advisories/new)
instead.

Include enough information to reproduce and assess the report:

- the affected `fastapi-request-observability`, Python, FastAPI, and Starlette
  versions;
- relevant middleware and logging configuration;
...
Report vulnerabilities that exist solely in Python, FastAPI, Starlette, HTTPX2,
or another dependency to the affected upstream project. General bugs and
hardening suggestions without a security impact belong in the
[public issue tracker](https://github.com/janisto/fastapi-observability/issues).
