...
Run `just package-check` when distribution contents or release metadata change.
Run `just mutation` when changing the traceparent parser or its focused tests.
